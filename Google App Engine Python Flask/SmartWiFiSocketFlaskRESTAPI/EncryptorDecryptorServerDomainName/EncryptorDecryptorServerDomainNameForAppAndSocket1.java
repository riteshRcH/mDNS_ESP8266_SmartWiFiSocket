...
public class EncryptorDecryptorServerDomainNameForAppAndSocket1
{
	...
	String serverDomainNameForApp = "https://unifysmartwifisocket.appspot.com";
	String serverDomainNameForSocket = "http://unifysmartwifisocket.appspot.com";
	...
	System.out.println("Encrypted Base64 encoded String: \t\t" + encryptedBase64EncodedString);
        System.out.println("Base64 decoded Decrypted String: \t\t" + decrypt("pW4dOmAINnAmE91!", "IV", encryptedBase64EncodedString));
