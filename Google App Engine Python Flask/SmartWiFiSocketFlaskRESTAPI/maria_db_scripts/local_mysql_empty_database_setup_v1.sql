...
GRANT USAGE ON *.* TO 'app'@'localhost' IDENTIFIED BY 'passwordForApPDBUserYo1259!';
DROP USER 'app'@'localhost';

CREATE USER 'app'@'localhost' IDENTIFIED BY 'passwordForApPDBUserYo1259!';
GRANT SELECT, INSERT, UPDATE ON unify_smart_wifi_socket.sockets_per_user TO 'app'@'localhost';

# https://stackoverflow.com/questions/598190/mysql-check-if-the-user-exists-and-drop-it
GRANT USAGE ON *.* TO 'socket'@'localhost' IDENTIFIED BY 'passwordForSoCkeTDBUserYo1259!';
DROP USER 'socket'@'localhost';

CREATE USER 'socket'@'localhost' IDENTIFIED BY 'passwordForSoCkeTDBUserYo1259!';
GRANT SELECT, UPDATE ON unify_smart_wifi_socket.sockets_per_user TO 'socket'@'localhost';
